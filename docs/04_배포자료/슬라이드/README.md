...
| 파일 | 무엇 | 언제 쓰나 | 장 | 스크립트 |
|---|---|---|---|---|
| `부록A-CSharp-지금은-안-배우는-것.pptx` | `CSharpStudyProject` 중 001–030 범위 밖 자료 | 학생이 "이건 왜 안 해요" 라고 물을 때 · 001회차 OT 뒤 | 16 | `generate_apxA.js` |
...
>
> 부록 A 의 회차 대응은 [`docs/00_기획/Csharp-학습자료-연동.md`](../../00_기획/Csharp-학습자료-연동.md) 와 같은 표를 쓴다.
